...
async function main() {
  ...
  const _hecUsdc = prod_mode ? '0x0b9589A2C1379138D4cC5043cE551F466193c8dE' : '0x9C4Ee29CD1C219623eBEA40A42b5af11414D7C90';
  const _hecTor = prod_mode ? '0xd02a80B4A58308B1aD8652abe348Ae2Ca241E636' : '0xd02a80B4A58308B1aD8652abe348Ae2Ca241E636';
  ...
  const votingContract = await hre.upgrades.deployProxy(
    votingFactory,
    [_hec, _sHec, _wsHec, _hecUsdc, _hecTor, _spookySwapFactory, _tokenVault, _maxPercentage, _voteDelay],
    {
      gas: gas,
