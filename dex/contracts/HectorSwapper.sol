...
import "./HectorSwapperStorage.sol";
...
contract HectorSwapper is HectorSwapperStorage, AccessControl {
    ...
    function getPartnerFeeStructure(address partner)
        public
        view
