...
async function main() {
	...
	const SPLITTER_ADDRESS = '0xaf070EB941b6f0d60ecc02FEeF1206d7aEfe44A6';	//new Hector Bridge Splitter v2
	...
	try {
		...
		// 	value: fee,
		// });
		const result = await testHecBridgeSplitterContract.Bridge(mockSendingAssetInfos, fees, mockCallDatas);
